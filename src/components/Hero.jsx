...
const Hero = () => {
    return (
        <div>
            <div className=" bg-[url('/images/heri-bg.jpg')] bg-cover bg-center bg-no-repeat h-screen">
                <div className='bg-[#31303099] h-full w-full flex flex-row justify-center text-center items-center'>
                    <div>
                        <h1 className='text-white dm-sns text-[64px]'>About Captiva Verde</h1>
